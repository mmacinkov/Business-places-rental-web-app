...
<html lang="hr">
    ...
    <body>
        ...
        <section>
            ...
            if (isset($stranica)) {
                ...
                if ($upit20->num_rows > 0) {
                    ...
                    if ($stranica <= 1) {
                        ...
                        $j = $stranica - 1;
                        echo "<span><a id='poveznica2' href='moderator.php?page=$j'>< Prethodna </a></span>";
                    }
                    for ($i = 1; $i <= $ukupnoStranica; $i++) {
                        if ($i <> $stranica) {
                            echo "<span><a id='poveznica2' href='moderator.php?page=$i'>$i</a></span>";
                        } else {
                    ...
                    if ($stranica == $ukupnoStranica) {
                        ...
                        $j = $stranica + 1;
                        echo "<span><a id='poveznica2' href='moderator.php?page=$j'>Sljedeća ></a></span>";
                    }
                }
            }
            ...
            echo '<form novalidate class="zaForme" action="moderator.php" method="post">';
            ...
            echo '<br><br>';
            echo '<form enctype="multipart/form-data" class="zaForme" novalidate action="moderator.php" method="post">';
            ...
            echo '<br><br>';
            echo '<form class="zaForme" novalidate action="moderator.php" method="post">';
